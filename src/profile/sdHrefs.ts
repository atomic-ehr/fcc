...
export default function sdHrefs(ctx: Context, opts: { resource: types.fcc.Resource }): types.profile.SdHrefs {
    const base = ctx.fns.core.pageHref(ctx, { resource: opts.resource }).replace(/\.html$/, "");
    return {
        base,
        content:     `${base}.html`,
