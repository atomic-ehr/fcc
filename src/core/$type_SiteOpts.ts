export type SiteOpts = {
    ...
    tabs?: Record<string, types.core.TabDescriptor[] | types.core.TabMergeSpec>;

    /** Block/callout handlers keyed by kramdown class. `false` disables a built-in. */
    blocks?: Record<string, types.md.BlockDescriptor | false>;
    ...
    tabRegistry?: Record<string, types.core.TabDescriptor[]>;
    sectionRegistry?: Record<string, string[]>;
    blockRegistry?: Record<string, types.md.BlockDescriptor>;
