...
export default function loadFns(ctx: Context): void {
    (ctx.fns as any).md = { applyBlocks, blockDefaults, expandIncludes, highlightBlocks, highlightCode, injectRefLinks, mdInline, mdToHtml, parseIal, sdListTable, stripUnrenderedLiquid, warmHighlighter };
}
