export type SiteOpts = {
    ...
    pagecontent?: string;
    /** IG static-image dir (relative to projectRoot); its files are copied to the
     *  site root so markdown `<img src="x.png">` resolves. IG-Publisher input/images. */
    images?: string;
    ...
    tabs?: Record<string, types.site_core.TabDescriptor[] | types.site_core.TabMergeSpec>;

    /** Block/callout handlers keyed by kramdown class. `false` disables a built-in. */
    blocks?: Record<string, types.site_md.BlockDescriptor | false>;
    ...
    tabRegistry?: Record<string, types.site_core.TabDescriptor[]>;
    sectionRegistry?: Record<string, string[]>;
    blockRegistry?: Record<string, types.site_md.BlockDescriptor>;
