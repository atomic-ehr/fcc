...
export default function mergeTabs(
    ctx: Context,
    opts: { defaults: Record<string, types.site_core.TabDescriptor[]>; overrides?: Record<string, types.site_core.TabDescriptor[] | types.site_core.TabMergeSpec> },
): Record<string, types.site_core.TabDescriptor[]> {
    void ctx;
    const out: Record<string, types.site_core.TabDescriptor[]> = {};
