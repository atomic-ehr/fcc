...
export default function loadFns(ctx: Context): void {
    (ctx.fns as any).site_md = { sanitizeHtml, anchorHeadings, applyBlocks, blockDefaults, expandIncludes, highlightBlocks, highlightCode, injectRefLinks, resolveLink, collectUnresolvedRefs, lrefMap, lrefResource, lrefAlias, lrefDependency, lrefFhirPath, mdInline, mdToHtml, parseIal, sdListTable, stripUnrenderedLiquid, warmHighlighter };
}
