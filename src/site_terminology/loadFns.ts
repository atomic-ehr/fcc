// Auto-assembled: imports every terminology fn and registers ctx.fns.site_terminology.
...
export default function loadFns(ctx: Context): void {
    (ctx.fns as any).site_terminology = { $section_cld, $section_concepts, $section_csReferences, $section_expansion, $section_vsReferences, codeSystemUsage, conceptTable, displayFor, renderValueSetJsonPage, valueSetUsage, vsCld, vsExpand };
}
