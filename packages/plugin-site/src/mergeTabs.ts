...
export default function mergeTabs(
    ctx: Context,
    opts: { defaults: Record<string, types.site.TabDescriptor[]>; overrides?: Record<string, types.site.TabDescriptor[] | types.site.TabMergeSpec> },
): Record<string, types.site.TabDescriptor[]> {
    void ctx;
    const out: Record<string, types.site.TabDescriptor[]> = {};
